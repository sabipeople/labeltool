...
#
#modification note: Output file and tableview to work with bunch of image files are added. 
#If i understand correctly, i can modify this program under the terms of the GNU General Public License.
#I modify it to fit my own purpose and open the source code to observe GNU terms.
#If i do something wrong let me know, I will correct it to obey GNU terms <sabi@outlook.kr>
#modified labelme is tested on pyqt5 and python 3.6 only.
#Note: the original program is labelme(as you might know). you can find it here <https://github.com/wkentaro>
#Thank you <wkentaro> for the good utility.
import argparse
import os.path
import re
import sys
...
from labelViewModel import *

__appname__ = 'modified_labelme'
